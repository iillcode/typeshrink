...
function activate(context) {
    ...
    const agentProvider = new agentPanelProvider_1.AgentPanelProvider(context.extensionUri, modelConfig, (0, registry_1.buildToolRegistry)(), context.workspaceState, agentLog);
